      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 sm:p-12 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 text-center sm:text-left">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#0E7C7B]/10 border border-[#0E7C7B]/20 px-3.5 py-1 font-tech text-xs font-bold text-[#0E7C7B]">
              <FileText size={14} />
              <span>[ HARDWARE RESOURCE GUIDE ]</span>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 text-xs font-extrabold text-slate-700 pt-1">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 size={15} className="text-[#0E7C7B]" />
                Updated 2026 Rates
              </span>
              <span className="flex items-center gap-1.5">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-2xl bg-white p-6 border border-slate-200 shadow-xl space-y-4">
              {isDownloaded ? (
                <div className="text-center py-4 space-y-2">
                  ...
                  <h4 className="text-lg font-black text-slate-900">Guide Ready!</h4>
                  <p className="text-xs text-slate-600">Opening WhatsApp download link...</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl bg-slate-50 border border-slate-200 px-3.5 py-2.5 text-xs text-slate-900 font-medium focus:border-[#0E7C7B] focus:outline-none"
                    />
                  </div>

                  <div className="space-y-1">
                    <label className="text-[10px] font-extrabold uppercase text-slate-500 tracking-wider">WhatsApp Phone *</label>
                    <input
                      type="tel"
                      required
