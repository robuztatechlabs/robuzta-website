...
export function FranchiseStickyPill() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 hidden md:flex items-center gap-3.5 rounded-2xl bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 px-4 text-slate-900 shadow-2xl shadow-slate-900/10 transition-all duration-300 hover:shadow-blue-500/15 hover:scale-[1.02] group">
      ...
      <div className="space-y-0.5 text-xs max-w-xs">
        ...
        <p className="text-[11px] text-slate-600 font-medium italic leading-tight">
          "Building India’s most trusted hardware repair lab network."
        </p>
      </div>
