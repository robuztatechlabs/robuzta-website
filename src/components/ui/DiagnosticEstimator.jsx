            ...
            {issueOptions[category].map((issue) => {
              ...
              return (
                <button
                  ...
                  className={`group relative p-4 rounded-2xl text-left transition-all duration-200 cursor-pointer border flex items-center gap-3.5 ${
                    isSelected
                      ? 'bg-gradient-to-br from-teal-50/90 to-emerald-50/40 border-[#0E7C7B] shadow-md ring-2 ring-[#0E7C7B]/30'
        ...
        <div className="lg:col-span-5 rounded-2xl bg-gradient-to-br from-[#0F172A] via-[#0B132B] to-[#070D1B] p-6 text-white flex flex-col justify-between space-y-6 shadow-xl relative overflow-hidden">
          ...
          <div className="space-y-3 pt-2 relative z-10">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full rounded-xl bg-slate-800/90 hover:bg-slate-700 border border-slate-700 px-5 py-3 text-xs font-bold text-slate-200 transition-all text-center font-tech"
            >
