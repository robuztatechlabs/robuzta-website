  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex flex-1 items-center justify-center gap-1 sm:gap-1.5 rounded-xl bg-[#0E7C7B] hover:bg-teal-700 px-1.5 sm:px-3 py-3 text-[11px] sm:text-xs font-black text-white shadow-sm transition-all min-h-[44px] cursor-pointer"
      >
