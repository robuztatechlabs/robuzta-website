...
export function LaptopExplorerSection() {
  ...
  return (
    <section
      id="laptop-explorer"
      className="relative overflow-hidden bg-slate-50 dark:bg-[#070e1a] border-b border-slate-200 dark:border-slate-800 py-16 lg:py-24 transition-colors duration-300"
    >
