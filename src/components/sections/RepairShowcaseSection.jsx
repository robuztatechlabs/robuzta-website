...
export function RepairShowcaseSection() {
  return (
    <section id="hardware-lab" className="relative bg-gradient-to-b from-white via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 py-10 sm:py-14 lg:py-16 border-b border-slate-200 dark:border-slate-700 overflow-hidden">
