...
export function TrustSection() {
  return (
    <section className="relative bg-slate-50 py-20 border-y border-slate-200 overflow-hidden">
      
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
        
        {/* Metric Stats Banner */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-8 rounded-3xl bg-white border border-slate-200 shadow-md">
          <div className="space-y-1 text-center md:text-left">
            <div className="text-3xl sm:text-4xl font-extrabold text-slate-900">
              <AnimatedCounter value="15000" suffix="+" />
            </div>
            <div className="text-xs font-bold uppercase tracking-wider text-slate-500">Devices Restored</div>
          ...
          <div className="space-y-1 text-center md:text-left">
            ...
            <div className="text-xs font-bold uppercase tracking-wider text-slate-500">Repair Success Rate</div>
          ...
          <div className="space-y-1 text-center md:text-left">
            ...
            <div className="text-xs font-bold uppercase tracking-wider text-slate-500">Avg Turnaround</div>
            <p className="text-[11px] text-emerald-600 font-semibold">Same-Day Express Service</p>
          </div>

          <div className="space-y-1 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-1.5 text-3xl sm:text-4xl font-extrabold text-slate-900">
              <span>4.9</span>
              <Star size={24} className="text-amber-500 fill-amber-500" />
            </div>
            <div className="text-xs font-bold uppercase tracking-wider text-slate-500">Verified Rating</div>
            <p className="text-[11px] text-slate-600 font-semibold">Based on 1,200+ Google Reviews</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {trustCards.map((card, idx) => (
            <motion.div
              ...
              className="group rounded-2xl bg-white border border-slate-200 p-6 space-y-3 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-500/10 transition-all"
            >
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="relative overflow-hidden py-4 border-y border-slate-200">
            <div className="animate-marquee flex items-center gap-12 text-sm font-bold text-slate-700 uppercase tracking-wider">
