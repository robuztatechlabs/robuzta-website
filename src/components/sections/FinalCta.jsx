...
export function FinalCta() {
  return (
    <section id="contact" className="relative bg-white dark:bg-slate-950 py-10 sm:py-14 lg:py-16 border-b border-slate-200 dark:border-slate-800 transition-colors duration-300 overflow-hidden">
