...
export function FinalCta() {
  return (
    <section id="contact" className="relative bg-white dark:bg-slate-950 py-16 sm:py-20 lg:py-24 border-b border-slate-200 dark:border-slate-800 transition-colors duration-300 overflow-hidden">
