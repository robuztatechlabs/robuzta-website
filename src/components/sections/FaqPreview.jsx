...
export function FaqPreview() {
  ...
  return (
    <section id="faq" className="relative bg-white py-24 border-b border-slate-200">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 text-left text-base font-bold text-slate-900 hover:text-blue-600 transition-colors"
                >
        ...
        <div className="text-center pt-4">
          <Link
            href="/faq"
            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-blue-700 hover:text-blue-800 bg-slate-50 border border-slate-200 px-6 py-3 rounded-xl shadow-sm transition-all"
          >
