          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogs.map((article) => (
                <article
                  key={article.slug}
                  className="rounded-3xl bg-slate-50/80 border border-slate-200 p-7 shadow-xl hover:border-[#0E7C7B]/40 hover:bg-white hover:shadow-2xl transition-all duration-300 flex flex-col justify-between space-y-5 group"
                >
                  <div className="space-y-4">
                    ...
                    <h2 className="text-xl font-extrabold text-slate-900 group-hover:text-[#0E7C7B] transition-colors leading-snug">
